import "./Header.scss";
import Menu, { MenuItems } from "./components/Menu/index";
        ...
        <div className="wrapper">
          <div className="inner">
            ...
            <div className="options">
              <Menu>
                <MenuItems title="Home" to={config.routes.home} />
                <MenuItems title="Info" to={config.routes.info} />
                <MenuItems title="Contact" to={config.routes.contacts} />
              </Menu>
            </div>
